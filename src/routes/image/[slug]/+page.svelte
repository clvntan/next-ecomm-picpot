    ...
    <div class="hero-content flex-col lg:flex-row my-20">
        ...
        <div class="flex flex-col lg:w-2/5 mt-8 mx-10">
            <div class="max-w w-full">
                ...
                <p class="badge badge-warning badge-lg text-neutral text-lg font-semibold">USD {humanize.formatNumber(data.image.price)}</p>
                ...
                <div class="flex flex-col mt-10">
                    ...
                    {#if data.image.userId == getUserId()}
                        <button type="submit" on:click={editButton} class="btn btn-outline btn-accent my-4">Edit</button>
                    {/if}
